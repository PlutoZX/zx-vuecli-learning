module.exports = {
    ...
    // 将构建好的文件输出到哪里
    outputDir: 'start', // TODO 原默认值为 'dist'
    ...
    css: {
        ...
        // 是否开启 CSS source map？
        sourceMap: true, // TODO 原默认值为false

        // 为预处理器的 loader 传递自定义选项。比如传递给
        // sass-loader 时，使用 `{ sass: { ... } }`。
        loaderOptions: {},

        // 为所有的 CSS 及其预处理文件开启 CSS Modules，能够不带 .module 后缀使用 CSS Modules。
        // 这个选项不会影响 `*.vue` 文件。
        modules: false
    },
    ...
    devServer: {
        ...
        host: '0.0.0.0',
        port: 8888, // TODO 原默认值为8080
        https: false,
        hotOnly: false,
        // 查阅 https://github.com/vuejs/vue-doc-zh-cn/vue-cli/cli-service.md#配置代理
        proxy: null, // string | Object
        before: app => {},
        disableHostCheck: true // TODO 注意注意重要重要 这个webpack配置项 不检查host才能在本地改host访问 否则自定义域名访问无效，只能ip地址访问
    },
