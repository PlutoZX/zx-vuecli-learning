 ...
 * @Date:   2017-10-13T17:06:17+08:00
 * @Email:  amourfrei@163.com
 * @Last modified by:   amour
 * @Last modified time: 2018-01-23T18:18:47+08:00
 */
...
(function (global, factory) {
    ...
    var ua = navigator.userAgent.toLowerCase(),
        ...
        CONST = {
            ...
            SHARE_ACTION_SET: "S",    // 设置分享信息
            SHARE_ACTION_PANE: "P",   // 唤起分享面板
            SHARE_ACTION_OPEN: "O"    // 直接分享到制定渠道
        };
     ...
     * @param callback
     */
    function makeShareResultCallback(callback) {
    ...
    function processingInputParam(inputParamObj) {
        if (isInputParamObjLegal(inputParamObj)) {
            try {
                var targetParamObj = {channel: '', callback: null}, hasCallbackFunc, callbackSwitcher;
                ...
                if (hasCallbackFunc) {
                    ...
                    // 设置回调函数
                    makeShareResultCallback(targetParamObj.callback);
                } else {
